...
setup:
	...
	curl "https://ftp.nluug.nl/pub/graphics/blender/release/Blender5.0/blender-5.0.1-linux-x64.tar.xz" --output blender-5.0.0-linux-x64.tar.xz
	tar -xf blender-5.0.0-linux-x64.tar.xz
	alias blender="./blender-5.0.0-linux-x64/blender"
